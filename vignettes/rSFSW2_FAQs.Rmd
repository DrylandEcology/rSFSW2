...
values). If they contain a different number of rows than the main input file contains,
...
in the main input file. The field 'Label' takes character values and can be used to
