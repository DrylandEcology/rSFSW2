...
dir.sw <- "Rsoilwat31_IntroductionExample/swrun"
swIn2 <- sw_inputDataFromFiles(dir=dir.sw, file.in="files_v30.in")
...
swOut <- sw_exec(data=swIn2, weatherList=weatherList, dir="", file.in="files_v30.in", echo=FALSE, quiet=FALSE, colNames=TRUE)
...
swProd_Composition(swIn2) <- c(0.4, 0.6, 0, 0)	
