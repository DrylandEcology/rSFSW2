...
static R_NativePrimitiveArgType C_dailyWeather2_R_t[6] = {INTSXP, REALSXP, REALSXP, INTSXP,
  INTSXP, INTSXP};
static R_NativePrimitiveArgType C_dailyWeather2Write_R_t[4] = {INTSXP, STRSXP, STRSXP,
  INTSXP};
static R_NativePrimitiveArgType C_monthlyClimate2_R_t[7] = {INTSXP, REALSXP, REALSXP,
  STRSXP, INTSXP, INTSXP, INTSXP};
static R_NativePrimitiveArgType C_writeMonthlyClimate2_R_t[1] = {STRSXP};

static const R_CMethodDef CEntries[] = {
    {"C_dailyWeather2_R",        (DL_FUNC) &C_dailyWeather2_R,        6, C_dailyWeather2_R_t},
    {"C_dailyWeather2Write_R",   (DL_FUNC) &C_dailyWeather2Write_R,   4, C_dailyWeather2Write_R_t},
    {"C_monthlyClimate2_R",      (DL_FUNC) &C_monthlyClimate2_R,      7, C_monthlyClimate2_R_t},
