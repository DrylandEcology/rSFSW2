...
test_that("Unit conversion", {
  ...
  expect_equal(convert_precipitation(temp_ppt, dpm, "mm/d"),
    temp_ppt * dpm / 10)
  expect_equal(convert_precipitation(temp_ppt, dpm, "cm/d"), temp_ppt * dpm)
  expect_equal(convert_precipitation(temp_ppt, dpm, "kg m-2 s-1"),
    temp_ppt * dpm * 8640)
  expect_error(convert_precipitation(temp_ppt, dpm, "L m-2"))
  expect_error(convert_precipitation(temp_ppt, dpm, "cm/month",
    unit_to = "L m-2"))
})
