...
#' @export
setup_rSFSW2_project_infrastructure <- function(dir_prj, verbose = TRUE, # nolint
  print.debug = FALSE) {
...
#' @export
populate_rSFSW2_project_with_data <- function(SFSW2_prj_meta, opt_behave, # nolint
...
#' @export
check_rSFSW2_project_input_data <- function(SFSW2_prj_meta, SFSW2_prj_inputs, # nolint
...
simulate_SOILWAT2_experiment <- function(SFSW2_prj_meta, SFSW2_prj_inputs,
  ...
  if (SFSW2_prj_meta[["prj_todos"]][["use_SOILWAT2"]] &&
    ...
    swof <- rSOILWAT2::sw_out_flags() # nolint
    swDefaultInputs <- read_SOILWAT2_DefaultInputs() # nolint
