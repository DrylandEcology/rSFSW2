...
.onLoad <- function(libname, pkgname) {
  ...
  # based on chapter "When you do need side-effects" by Wickham, H. 2015. R packages.
  ...
  assign("windspeed_height_m", 2L, envir = SFSW2_glovars) # SOILWAT2 assumes 2 m height
  ...
  #-- Parallel framework
  assign("p_type", NA_character_, envir = SFSW2_glovars) # Type of parallel framework: 'mpi' or 'socket'
