...
if (use_rcpp && requireNamespace("Rcpp")) {
  Rcpp::sourceCpp(file = file.path(dir.code, "src", "GISSM_get_KilledBySoilLayers.cpp"))
...
if (use_rcpp && requireNamespace("Rcpp")) {
  Rcpp::sourceCpp(file = file.path(dir.code, "src", "GISSM_germination_wait_times.cpp"))
...
if (use_rcpp && requireNamespace("Rcpp")) {
  Rcpp::sourceCpp(file = file.path(dir.code, "src",
    "GISSM_setFALSE_SeedlingSurvival_1stSeason.cpp"))
